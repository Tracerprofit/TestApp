...
class Chat2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let label = UILabel(frame: CGRect(x: 50, y: 100, width: 300, height: 40))
        label.text = "Контакт второй"
    ...
    func addViewNavBar(){
        ...
        let labelInView = UILabel(frame: CGRect(x: 0, y: 0, width: 190, height: 38))
        labelInView.center = mainView.center
        labelInView.text = "Максим Каптановский"
