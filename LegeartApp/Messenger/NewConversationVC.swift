...
class NewConversationVC: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        noResultLabel.frame = CGRect(x: view.fs_width/4, y: (view.fs_height-200)/2, width: view.fs_width/2, height: 200)
    }
...
extension NewConversationVC: UISearchBarDelegate {
    ...
    func searchUsers(query: String){
        ...
        func filterUsers(with term: String){
            ...
            let safeEmail = ChatViewController.safeEmail(emailAddress: currentUserEmail)
        ...
        if hasFetched{
            ...
            StorageManager.shared.getAllUsers(completion: { [weak self] result in
                switch result {
...
//                self.searchedUsers.isHidden = true
                self.tableView.isHidden = true
            } else {
                self.noResultLabel.isHidden = true
//                self.searchedUsers.isHidden = false
